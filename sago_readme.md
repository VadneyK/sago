...
### Sample Input 1: Pitch Deck (TechFlow AI)

**Source**: Email attachment from founder@techflow.ai  
**File**: `techflow_deck.pdf`
...
### Sample Output 1: Verification Report
...
### Sample Output 2: Personalized Questions

**Context**: Investor profile shows focus on B2B SaaS, enterprise distribution, unit economics
...
### Sample Output 3: Automated Actions

**Slack Post** (`#deal-flow` channel):
```
...
**Gmail Draft** (Auto-created in investor's outbox):
```
To: founder@techflow.ai
